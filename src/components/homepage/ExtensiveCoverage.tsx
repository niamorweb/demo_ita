...
//     <section
//       ref={ref2}
//       className="relative pb-32 px-10 h-[250vh] overflow-x-hidden bg-gradient-to-b flex flex-col items-center"
//     >
//       <div className="sticky top-[80px]">
//         <div className="max-w-[1400px] py-16 relative mx-auto flex flex-col gap-12 text-white items-center text-center">
//           <motion.div
//             style={{ scale, borderRadius }}
//             className="absolute max-w-[95vw] w-full h-full -translate-x-1/2 -translate-y-1/2 bg-gradient-to-b from-[#232222] via-[#141313] to-95% to-black "
//           ></motion.div>
//           <div className="flex flex-col gap-14 max-w-[1000px] z-10">
//             <div className="flex flex-col gap-3">
//               <span className="uppercase text-sm lg:text-base">
//                 Couverture étendue
//               </span>
//               <h2 className="text-xl lg:text-3xl font-semibold text-[#fff]">
//                 Large couverture du territoire français et à l’international
//               </h2>
//             </div>
//             <div className="flex flex-col-reverse items-center gap-10 justify-around">
...
//                 <motion.img
//                   style={{ y: parallaxY }}
//                   className="w-[200px] lg:w-[500px] aspect-auto h-auto rounded-lg"
//                   src="https://cdn.pixabay.com/photo/2020/06/23/06/45/dji-5331570_1280.jpg"
//                   alt=""
//                 ></motion.img>{" "}
//                 <div className="-translate-x-10">
//                   <motion.img
//                     style={{ y: parallaxY2 }}
//                     className="w-[200px] h-[200px] lg:w-[500px] lg:h-[500px] object-cover rounded-lg"
//                     src="https://cdn.pixabay.com/photo/2019/11/14/19/41/forest-4626959_1280.jpg"
//                     alt=""
//                   ></motion.img>
//                 </div>
...
//               <div className="flex flex-col w-full gap-3 text-start text-white/70">
//                 <p>
//                   Intheair déploie la première plateforme française de
//                   visualisation et d'exploitation de vos projets digitalisés.
//                 </p>
